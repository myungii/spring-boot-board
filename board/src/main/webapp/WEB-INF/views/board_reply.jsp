...
<table width="700"  border='0' cellspacing="0">
 <form name="frm" method="get" action="boardreply.do">
 	idx: <input type="text"  name="hobby_idx"  value="${dto.hobby_idx}" readonly><br>
 	<tr>
 	  <td><img src="resources/images/x1.gif">작성자:
 		<input type="text"  name="rwriter" size=30>
 	...
 	<tr>
 	  <td>
 		<img src="resources/images/x1.gif">메모글: <textarea  name="rmemo" cols="60" rows=3></textarea>
 	  </td>
 	</tr>
 </form>
</table>
